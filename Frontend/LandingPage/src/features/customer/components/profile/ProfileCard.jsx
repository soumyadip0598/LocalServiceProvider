    ...
    <div className="bg-white shadow-xl rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-[1.01]">
      ...
      <div className="px-6 pb-6">
              ...
              <div className="w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-gray-200 flex items-center justify-center shadow-lg transform transition-transform duration-300 hover:scale-105">
                <img 
                  src={profile.profileImage && getAvatarImageUrl(profile.profileImage) 
                    ...
                    : getAvatarImageUrl('default_avatar.jpeg') // Use the default avatar
                  } 
        ...
        <div className="mt-16 text-center">
          ...
          <button 
            onClick={onEditClick}
            className="mt-6 inline-flex items-center px-6 py-2.5 bg-emerald-500 text-white font-semibold rounded-full shadow-md hover:bg-emerald-600 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          >
        ...
        <div className="mt-8 border-t border-gray-200 pt-6 space-y-4">
          ...
          {profile.signupDate && profile.signupDate !== 'N/A' && (
            <div className="flex items-center text-gray-700">
              <CalendarDays className="h-5 w-5 text-emerald-500 mr-3 flex-shrink-0" />
